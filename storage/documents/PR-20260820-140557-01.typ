...
#grid(
    ...
    align(right)[
        #rect(
            ...
            #v(2pt)
            #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[PR-20260820-140557-01]
        ]
    ]
)
    ...
    [
        #block(
            ...
            #grid(
                ...
                [Prioritas / Urgensi:], [#text(weight: "bold", fill: rgb("#b45309"))[URGENT]],
...
#table(
    ...
    [*No*], [*SKU*], [*Deskripsi Item*], [*Jumlah*], [*Harga Satuan*], [*Total Harga*],
            ...
            [3],
            [ATK-KERTAS-F4],
            [Kertas HVS Sinar Dunia F4 75 GSM (Box 5 Rim)],
            [38 box],
            [Rp 238.000],
            [Rp 9.044.000],
...
#align(right)[
    #block(width: 250pt)[
        #table(
            ...
            inset: 3pt,
            align: (left, right),
            [Subtotal Rincian:], [Rp 24.444.000],
            [PPN 11% (Pajak Masukan):], [Rp 2.688.840],
            [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))], [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))],
            [#text(weight: "bold", size: 10.5pt)[TOTAL ESTIMASI:]], [#text(weight: "bold", size: 10.5pt, fill: rgb("#0f172a"))[Rp 27.132.840]]
        )
    ]
]
