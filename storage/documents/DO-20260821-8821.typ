...
#grid(
    ...
    align(right)[
        #rect(
            ...
            #v(2pt)
            #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[DO-20260821-8821]
        ]
    ]
)
...
#table(
    ...
    [*No*], [*SKU*], [*Deskripsi Item*], [*Jumlah*], [*Harga Satuan*], [*Total Harga*],
            ...
            [3],
            [FMCG-GULA-01],
            [Gula Pasir Gulaku Premium Tebu 1 Kg],
            [60 kg],
            [Rp 17.500],
            [Rp 1.050.000],
            ...
            [5],
            [OFC-KERTAS-01],
            [Kertas HVS PaperOne A4 80 GSM (Box 5 Rim)],
            [25 box],
            [Rp 245.000],
            [Rp 6.125.000],
...
#align(right)[
    #block(width: 250pt)[
        #table(
            ...
            inset: 3pt,
            align: (left, right),
            [Subtotal Rincian:], [Rp 22.760.000],
            [PPN 11% (Pajak Masukan):], [Rp 2.503.600],
            [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))], [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))],
            [#text(weight: "bold", size: 10.5pt)[TOTAL ESTIMASI:]], [#text(weight: "bold", size: 10.5pt, fill: rgb("#0f172a"))[Rp 25.263.600]]
        )
    ]
]
...
// Notes
#if "Surat Jalan Penerimaan Barang Masuk & Update Stok Gudang." != "" [
    #block(
        fill: rgb("#fffbeb"),
        inset: 7pt,
        radius: 4pt,
        ...
        #text(size: 8pt, fill: rgb("#78350f"))[Surat Jalan Penerimaan Barang Masuk & Update Stok Gudang.]
    ]
]
