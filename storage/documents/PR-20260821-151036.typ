...
#grid(
    ...
    align(right)[
        #rect(
            ...
            #v(2pt)
            #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[PR-20260821-151036]
        ]
    ]
)
    ...
    [
        #block(
            ...
            #grid(
                ...
                gutter: 4pt,
                [ID Vendor:], [SUP-003],
                [Nama Vendor:], [#text(weight: "bold")[PT Sinarmas Pulp & Paper Supply]],
...
#table(
    ...
    [*No*], [*SKU*], [*Deskripsi Item*], [*Jumlah*], [*Harga Satuan*], [*Total Harga*],
            ...
            [1],
            [ATK-PEN-01],
            [Ballpoint Faster C600 Black 0.7mm (Pack 12 pcs)],
            [1 pack],
            [Rp 38.500],
            [Rp 38.500],
...
#align(right)[
    #block(width: 250pt)[
        #table(
            ...
            inset: 3pt,
            align: (left, right),
            [Subtotal Rincian:], [Rp 38.500],
            [PPN 11% (Pajak Masukan):], [Rp 4.235],
            [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))], [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))],
            [#text(weight: "bold", size: 10.5pt)[TOTAL ESTIMASI:]], [#text(weight: "bold", size: 10.5pt, fill: rgb("#0f172a"))[Rp 42.735]]
        )
    ]
]
...
// Notes
#if "Purchase Requisition berisi 1 item barang. Menunggu persetujuan manajer." != "" [
    #block(
        fill: rgb("#fffbeb"),
        inset: 7pt,
        radius: 4pt,
        ...
        #text(size: 8pt, fill: rgb("#78350f"))[Purchase Requisition berisi 1 item barang. Menunggu persetujuan manajer.]
    ]
]
