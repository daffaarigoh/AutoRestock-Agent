...
#grid(
    ...
    align(right)[
        #rect(
            ...
            #v(2pt)
            #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[PR-20260821-102912-01]
        ]
    ]
)
...
#table(
    ...
    [*No*], [*SKU*], [*Deskripsi Item*], [*Jumlah*], [*Harga Satuan*], [*Total Harga*],
            ...
            [4],
            [FMCG-SUSU-01],
            [Susu UHT Ultra Milk Plain 1000ml (Karton 12 pcs)],
            [42 karton],
            [Rp 215.000],
            [Rp 9.030.000],
...
#align(right)[
    #block(width: 250pt)[
        #table(
            ...
            inset: 3pt,
            align: (left, right),
            [Subtotal Rincian:], [Rp 20.579.500],
            [PPN 11% (Pajak Masukan):], [Rp 2.263.745],
            [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))], [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))],
            [#text(weight: "bold", size: 10.5pt)[TOTAL ESTIMASI:]], [#text(weight: "bold", size: 10.5pt, fill: rgb("#0f172a"))[Rp 22.843.245]]
        )
    ]
]
