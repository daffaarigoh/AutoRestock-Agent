...
#grid(
    ...
    align(right)[
        #rect(
            ...
            #v(2pt)
            #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[PR-20260820-165115-01]
        ]
    ]
)
...
#align(right)[
    #block(width: 250pt)[
        #table(
            ...
            inset: 3pt,
            align: (left, right),
            [Subtotal Rincian:], [Rp 24.500],
            [PPN 11% (Pajak Masukan):], [Rp 2.695],
            [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))], [#line(length: 100%, stroke: 0.5pt + rgb("#94a3b8"))],
            [#text(weight: "bold", size: 10.5pt)[TOTAL ESTIMASI:]], [#text(weight: "bold", size: 10.5pt, fill: rgb("#0f172a"))[Rp 27.195]]
        )
    ]
]
