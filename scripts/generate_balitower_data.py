...
import json
wf_list = [
    ("WF-001", "Auto Restock Material Kritis", "Memeriksa stok material menara & kabel FO yang menipis dan membuat draf PR.", "Periksa stok material kritis, hitung kebutuhan restock, dan buat dokumen Purchase Requisition.", json.dumps({"workflow": "auto_restock", "steps": [{"type": "tool", "tool": "inventory.get_low_stock"}]}), "INVENTORY"),
